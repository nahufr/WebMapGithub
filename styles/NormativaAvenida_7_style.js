var size = 0;
var placement = 'point';
function categories_NormativaAvenida_7(feature, value, size, resolution, labelText,
...
case 'PROHIBIDO ESTACIONAR Y DETENERSE 24 HORAS':
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(174,31,2,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 3}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
default:
                    return [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(99,222,32,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 0}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
var style_NormativaAvenida_7 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_NormativaAvenida_7(feature, value, size, resolution, labelText,
